...
def peak_params():
    ...
    return {
        "pos_x": torch.as_tensor([25.0, 35.0], dtype=torch.float32),
        "pos_y": torch.as_tensor([25.0, 15.0], dtype=torch.float32),
        "height": torch.as_tensor([1.0, 0.5], dtype=torch.float32),
        "width": torch.as_tensor([2.0, 2.0], dtype=torch.float32),
        "ratio": torch.as_tensor([0.5, 0.5], dtype=torch.float32),
