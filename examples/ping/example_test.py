...
print('MSE original: ', np.array((model-image)**2).mean() ,'\n',
      'MSE python1: ', np.array((I1_same.image_fitted[0]-I1_same.image[0])**2).mean() ,'\n',
      'MSE python2: ', np.array((I1_change.image_fitted[0]-I1_change.image[0])**2).mean() ,'\n',
      'crystal only \n',
      'MSE original: ', np.array((model[I1_same.use_coor[0], I1_same.use_coor[1]]-image[I1_same.use_coor[0], I1_same.use_coor[1]])**2).mean() ,'\n',
      'MSE python1: ', np.array((I1_same.image_fitted[0][I1_same.use_coor[0], I1_same.use_coor[1]]-I1_same.image[0][I1_same.use_coor[0], I1_same.use_coor[1]])**2).mean() ,'\n',
      'MSE python2: ', np.array((I1_change.image_fitted[0][I1_same.use_coor[0], I1_same.use_coor[1]]-I1_change.image[0][I1_same.use_coor[0], I1_same.use_coor[1]])**2).mean() ,'\n',
)
fig.dpi = 300
...
volume = np.vstack([I1.gaussian_prmt[0]['weight']*(I1.gaussian_prmt[0]['sig']**2), I2.gaussian_prmt[0]['weight']*(I2.gaussian_prmt[0]['sig']**2)])
coor = I2.gaussian_prmt[0]['mean']
...
#%%
plt.figure()
plt.scatter(g1.coordinates[0,:], g1.coordinates[1,:], abs(g1.thickness-g2.thickness))
# %%
